...
const SkuDetailsForm: FC<ISkuDetailsFormProps> = ({
  ...
  return (
    <Card style={{ padding: "10px" }}>
      <h6 style={{ color: "green" }}>Thông tin bản quyền ::</h6>
      <Form>
        <Form.Group controlId="formBasicEmail">
          <Form.Label>Tên key</Form.Label>
          <Form.Control
            type="text"
        ...
        <Form.Group controlId="formBasicPassword">
          <Form.Label>Vĩnh viễn</Form.Label>{" "}
          <small style={{ color: "grey" }}>
            (nếu check thì không cần chỉnh thời gian)
            <Form.Check
              type="switch"
              id="custom-switch"
              label="Vĩnh Viễn"
